...
# select cog$numeracy_1 >= 0 & cog$numeracy_2 >= 0 row, put numbers into 
...
# select cog$numeracy_1 >= 0 & cog$numeracy_2 < 0 row, put single exist numeracy_1 numbers into 
numeracy[cog$numeracy_1 >= 0 & cog$numeracy_2 < 0] = cog$numeracy_1[cog$numeracy_1 >= 0 & cog$numeracy_2 < 0]
# select cog$numeracy_1 < 0 & cog$numeracy_2 >= 0 row, put single exist numeracy_2 numbers into 
numeracy[cog$numeracy_1 < 0 & cog$numeracy_2 >= 0] = cog$numeracy_2[cog$numeracy_1 < 0 & cog$numeracy_2 >= 0]
# add numeracy into cog
...
# choose ind not na in numeracy and cog$recall_1 >= 0 & cog$recall_2 >= 0 & cog$orienti >= 0
ind = cog$recall_1 >= 0 & cog$recall_2 >= 0 & cog$orienti >= 0 & !is.na(numeracy)
# add all to cogscore if row with cog$recall_1 >= 0 & cog$recall_2 >= 0 & cog$orienti >= 0 & !is.na(numeracy)
